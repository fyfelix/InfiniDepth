...
Arguments:
  ...
  camera_type           HAMMER raw depth type: d435, l515, or tof.
...
Environment overrides:
  ...
  OUTPUT_DIR            Prediction/evaluation output directory. Default: <checkpoint_dir>/hammer_<checkpoint_stub>_data_<camera_type>
...
case "${camera_type}" in
    d435|l515|tof) ;;
    *)
        echo "camera_type must be d435, l515, or tof, got: ${camera_type}" >&2
        exit 2
        ;;
esac
